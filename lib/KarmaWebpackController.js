...
class KarmaSyncPlugin {
  /**
   * @param {{ karmaEmitter: import('karma').Server, controller: KarmaWebpackController }} options
   */
  constructor(options) {
...
class KarmaWebpackController {
  ...
  /**
   * @param {import('karma').Server | null} emitter
   */
  ...
  /**
   * @returns {import('karma').Server | null} emitter
   */
  get karmaEmitter() {
